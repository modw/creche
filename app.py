...
childcare_type = st.sidebar.selectbox(
    "Child Care Type",
    ["Center-based", "Family Care (Small Group)", "Family Care (Large Group)"])
...
fig_monthly = px.line(
    df_monthly, x='Month', y='Monthly Cost', title='Monthly Child Care Costs')
...
fig_cumulative.update_layout(yaxis_title='Total Cost ($)', xaxis_title='Month')
